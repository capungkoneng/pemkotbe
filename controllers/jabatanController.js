...
const getAllPageJabatan = async (req, res) => {
  try {
    ...
    const totalRows = await model.jabatan.count();
    const results = await model.jabatan.findAll({
      where: {
        [Op.or]: [
          {
            nama: {
...
const addJabatan = async (req, res) => {
  try {
    ...
    const result = await model.jabatan.create(req.body, {
...
const updateJabatan = async (req, res) => {
  ...
  try {
    ...
    const result = await model.jabatan.update(
      req.body,
      {
        where: {
          id: id,
...
const deleteJabatan = async (req, res) => {
  ...
  try {
    ...
    const result = await model.jabatan.destroy(
      {
        where: {
          id: id,
        },
