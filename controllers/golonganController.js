...
const getAllPageGol = async (req, res) => {
  try {
    ...
    const totalRows = await model.golongan.count();
    const results = await model.golongan.findAll({
      where: {
        [Op.or]: [
          {
            nama: {
...
const addGol = async (req, res) => {
  try {
    ...
    const result = await model.golongan.create(req.body, {
...
const updateGol = async (req, res) => {
  ...
  try {
    ...
    const result = await model.golongan.update(
      req.body,
      {
        where: {
          id: id,
...
const deleteGol = async (req, res) => {
  ...
  try {
    ...
    const result = await model.golongan.destroy(
      {
        where: {
          id: id,
        },
