...
const getAllPageBidang = async (req, res) => {
  try {
    ...
    const totalRows = await model.bidang.count();
    const results = await model.bidang.findAll({
      where: {
        [Op.or]: [
          {
            nama: {
...
const addBidang = async (req, res) => {
  try {
    ...
    const result = await model.bidang.create(req.body, {
...
const updateBidang = async (req, res) => {
  ...
  try {
    ...
    const result = await model.bidang.update(
      req.body,
      {
        where: {
          id: id,
...
const deleteBidang = async (req, res) => {
  ...
  try {
    ...
    const result = await model.bidang.destroy(
      {
        where: {
          id: id,
        },
