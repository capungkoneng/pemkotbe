...
const getAllSp2d = async (req, res) => {
  try {
    ...
    const totalRows = await model.sp2d.count();
    const results = await model.sp2d.findAll({
      where: {
        [Op.or]: [
          {
            nama_penerima: {
...
const updateSp2d = async (req, res) => {
  ...
  try {
    ...
    const result = await model.sp2d.update(
      req.body,
      {
        where: {
          id: id,
...
const deleteSp2d = async (req, res) => {
  ...
  try {
    ...
    const result = await model.sp2d.destroy(
      {
        where: {
          id: id,
        },
...
const getOneSp2d = async (req, res) => {
  try {
    const result = await model.sp2d.findOne({
      where: {
        id: req.params.id,
      },
    });
